...
class TeachInChina(object):
    def __init__(self, max_page):
        self.start_urls = ['http://www.jobleadchina.com/job?job_industry=Teaching&company_name=&page={}'.format(page) for page in range(1, max_page + 1)]
    ...
    def parse_data(res, page):
        if res.status_code == 200:
            ...
            salary = [slr.strip() for slr in parsed.xpath(
                '//*[@class="salaryRange"]/text()')]
